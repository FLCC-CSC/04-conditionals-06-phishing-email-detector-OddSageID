...
# NAME: kevin hormaza 
# DATE: October 6, 2025
# BRIEF DESCRIPTION: This program analyzes an email subject line for possible phishing indicators
# based on common red flag keywords. It outputs a security assessment rating
# depending on the level of risk detected.
...
Once i understood that 'in' checks substrings inside text.
converting the input to lowercase made the matching simple and consistent.
